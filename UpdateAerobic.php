<?php
    ...
    if($userSex != "") {
        ...
        $sql2 = "UPDATE userTBL SET userTBL.aerobicScore = (SELECT SUM(aerobicTBL.Score) FROM aerobicTBL WHERE aerobicTBL.userID = userTBL.userID AND userDate > '$start' AND userDate < '$end')";
